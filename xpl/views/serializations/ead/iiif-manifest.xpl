...
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:oxf="http://www.orbeon.com/oxf/processors" xmlns:xforms="http://www.w3.org/2002/xforms"
	...
	<p:choose href="#data">
		<p:when test="descendant::ead:daoloc[@xlink:role='IIIFService']">
			<!-- iterate through the daogrps with IIIF Services -->
			<p:for-each href="#data" select="descendant::ead:daoloc[@xlink:role='IIIFService']" root="images" id="images">
				...
				<p:processor name="oxf:xslt">
					...
					<p:input name="config">
						<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
							...
							<xsl:variable name="service" select="concat(descendant::*/@xlink:href, '/info.json')"/>
							<xsl:template match="/">
				...
				<p:processor name="oxf:xslt">
					...
					<p:input name="config">
						<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema"
							xmlns:tei="http://www.tei-c.org/ns/1.0">
							<xsl:variable name="service" select="descendant::*/@xlink:href"/>
							<xsl:template match="/">
								<image uri="{$service}">
			...
			<p:processor name="oxf:unsafe-xslt">
				...
				<p:input name="config" href="../../../../ui/xslt/serializations/ead/iiif-manifest.xsl"/>
